...
from planner_BabyNet import BabyNet
...
class PlannerNetTrainer:
    ...
    def init_wandb(self):
        wandb.login(key="ed91171efa6085efd14647f7ba1396ba9e1af2e7")
        ...
        self.wandb_run = wandb.init(
            ...
            config={
                ...
                "architecture": "FlyNet",  # Replace with your actual architecture
    ...
    def prepare_data(self):
        ...
        depth_transform = transforms.Compose([
            ...
            transforms.GaussianBlur(kernel_size=3, sigma=(0.02)),
            transforms.ToTensor()])
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            wandb.log({"Avg Training Loss": train_loss, "Validation Loss": val_loss, "Duration (min)": duration, "lr" : self.optimizer.param_groups[-1]['lr']})
            ...
            if val_loss < self.best_loss:
                ...
                filename = "models/saving/net-ep" + str(epoch+1) + ".h5"
                torch.save(self.net.state_dict(), filename)
                torch.save(self.net.encoder.state_dict(), 'models/saving/encoder.pt')
                torch.save(self.net.decoder.state_dict(), 'models/saving/decoder.pt')
                wandb.save(filename)
                wandb.save('models/saving/encoder.pt')
                wandb.save('models/saving/decoder.pt')
